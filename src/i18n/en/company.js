export default {
  ...
  emailSettings: {
    ...
    gmailInstructions:
      'For Gmail, use smtp.gmail.com:587 and enable 2-factor authentication with App Password',
  },
  ...
  emailNotifications: {
    ...
    description: 'Configure automatic email notifications for various events',
    automaticNotifications: 'Automatic Notifications',
    newInvoiceCreated: 'New Invoice Created',
    newInvoiceDescription: 'Send email to client when new invoice is created',
    invoiceStatusChanged: 'Invoice Status Changed',
    invoiceStatusDescription: 'Notify client about invoice status changes (paid, cancelled)',
    paymentReminder: 'Payment Reminder',
    paymentReminderDescription: 'Send reminders for unpaid invoices',
    selectTemplate: 'Select Template',
    sendAutomatically: 'Send Automatically',
    sendAutomaticallyDescription: 'If disabled, emails need to be sent manually',
    statusTemplates: 'Templates for statuses',
